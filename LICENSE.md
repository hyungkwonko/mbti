...
명시적인 서면 허가 없이 다음 행위를 금지합니다:

1. **복제 금지**: 본 저작물의 전부 또는 일부를 복사, 복제하는 행위
2. **배포 금지**: 본 저작물을 제3자에게 배포, 전송, 공유하는 행위
3. **수정 금지**: 본 저작물을 변형, 수정, 2차 저작물을 만드는 행위
4. **상업적 사용 금지**: 본 저작물을 영리 목적으로 사용하는 행위
5. **재라이선스 금지**: 본 저작물에 대한 권리를 타인에게 부여하는 행위

### 허용 사항

- 개인적, 비상업적 목적으로 본 웹사이트에서 테스트를 이용하는 것
- 저작권자를 명시한 링크 공유 (hyungkwonko.info/mbti)

### 위반 시 조치

본 라이선스를 위반할 경우, 저작권자는 다음의 법적 조치를 취할 수 있습니다:
...
1. **No Copying**: Copying or reproducing this work in whole or in part
2. **No Distribution**: Distributing, transmitting, or sharing this work with third parties
3. **No Modification**: Modifying, altering, or creating derivative works
4. **No Commercial Use**: Using this work for commercial or profit-generating purposes
5. **No Sublicensing**: Granting rights to this work to others

### Permitted Actions

- Using the test on this website for personal, non-commercial purposes
- Sharing links with proper attribution to the copyright holder (hyungkwonko.info/mbti)
...
- Email: [Copyright holder's email]
- Website: hyungkwonko.info
