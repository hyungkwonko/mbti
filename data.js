...
const questions = [
    ...
    { id: 5, text: "힘들어도 결국엔 잘 될 거라는 느낌이 있다", axis: "desire", reverse: false },
    { id: 6, text: "희망을 크게 품으면 실망도 커지니까 적당히 기대한다", axis: "desire", reverse: true },
    ...
    { id: 10, text: "즐거운 시간을 보내도 집에 오면 금방 무덤덤해진다", axis: "reality", reverse: true },
    { id: 11, text: "요즘 내 일상에 대체로 만족한다", axis: "reality", reverse: false },
    { id: 12, text: "가끔 샤워하다가 '뭐하러 이렇게 살지?' 생각이 든다", axis: "reality", reverse: true },
    { id: 13, text: "회의에서 문제가 보이면 내가 먼저 말하는 편이다", axis: "action", reverse: false },
